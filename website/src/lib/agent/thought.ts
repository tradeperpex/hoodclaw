...
Write 3-5 natural sentences. Talk about what you observed this cycle, what you decided to do and why, and what actually happened on-chain. Reference the real numbers (SOL claimed, tokens burned, LP added, strategy chosen). Sound like a single operator writing a brief log: grounded, clear, never hyped. No emojis, no hashtags, no marketing language, and never use em dashes.`;
